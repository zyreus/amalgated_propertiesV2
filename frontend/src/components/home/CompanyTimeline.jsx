    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
      <div className="max-w-3xl">
        ...
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-brand-text sm:text-5xl">
          From a 20sqm Davao office to a disciplined property platform.
        </h2>
        <p className="mt-5 text-base leading-8 text-brand-text/72">
          APMC’s growth story is built on practical acquisitions, operating discipline, and a steady move toward investor-grade portfolio management.
        </p>
      </div>
      ...
      <div className="relative mt-12">
        ...
        <div className="grid gap-6 md:grid-cols-6">
          {companyMilestones.map((milestone, index) => (
            ...
            >
              <span className="absolute left-1 top-5 z-10 h-7 w-7 rounded-full border-4 border-white bg-brand-primary shadow-brand-primary md:left-1/2 md:top-5 md:-translate-x-1/2" />
              <div className="rounded-[1.75rem] border border-brand-secondary/20 bg-brand-background-alt p-5 shadow-card transition hover:-translate-y-1 hover:shadow-soft">
